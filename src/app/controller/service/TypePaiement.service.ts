...
export class TypePaiementService {
    ...
    public save(): Observable<TypePaiementVo> {
         return this.http.post<TypePaiementVo>(this.API, this.selectedTypePaiement);
    }
    ...
    public edit(): Observable<TypePaiementVo> {
     ...
     public findByCriteria(typePaiement:TypePaiementVo):Observable<Array<TypePaiementVo>>{
           return this.http.post<Array<TypePaiementVo>>(this.API +'search', typePaiement);
    }
