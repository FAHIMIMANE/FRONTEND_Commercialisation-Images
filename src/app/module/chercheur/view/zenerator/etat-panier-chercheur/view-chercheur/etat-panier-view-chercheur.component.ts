...
@Component({
  selector: 'app-etat-panier-view-chercheur',
  templateUrl: './etat-panier-view-chercheur.component.html',
  styleUrls: ['./etat-panier-view-chercheur.component.css']
})
export class EtatPanierViewChercheurComponent implements OnInit {
