...
@Component({
  selector: 'app-etat-panier-edit-chercheur',
  templateUrl: './etat-panier-edit-chercheur.component.html',
  styleUrls: ['./etat-panier-edit-chercheur.component.css']
})
export class EtatPanierEditChercheurComponent implements OnInit {
