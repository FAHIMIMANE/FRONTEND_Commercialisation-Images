...
@Component({
  selector: 'app-etat-panier-list-chercheur',
  templateUrl: './etat-panier-list-chercheur.component.html',
  styleUrls: ['./etat-panier-list-chercheur.component.css']
})
export class EtatPanierListChercheurComponent implements OnInit {
   // declarations
