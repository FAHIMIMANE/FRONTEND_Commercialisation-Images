...
@Component({
  selector: 'app-state-bucket-list-chercheur',
  templateUrl: './state-bucket-list-chercheur.component.html',
  styleUrls: ['./state-bucket-list-chercheur.component.css']
})
export class StateBucketListChercheurComponent implements OnInit {
   // declarations
