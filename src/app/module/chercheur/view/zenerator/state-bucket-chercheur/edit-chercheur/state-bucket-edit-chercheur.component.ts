...
@Component({
  selector: 'app-state-bucket-edit-chercheur',
  templateUrl: './state-bucket-edit-chercheur.component.html',
  styleUrls: ['./state-bucket-edit-chercheur.component.css']
})
export class StateBucketEditChercheurComponent implements OnInit {
