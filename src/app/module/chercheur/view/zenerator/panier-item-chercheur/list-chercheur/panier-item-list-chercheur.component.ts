...
@Component({
  selector: 'app-panier-item-list-chercheur',
  templateUrl: './panier-item-list-chercheur.component.html',
  styleUrls: ['./panier-item-list-chercheur.component.css']
})
export class PanierItemListChercheurComponent implements OnInit {
   // declarations
