...
@Component({
  selector: 'app-panier-item-edit-chercheur',
  templateUrl: './panier-item-edit-chercheur.component.html',
  styleUrls: ['./panier-item-edit-chercheur.component.css']
})
export class PanierItemEditChercheurComponent implements OnInit {
