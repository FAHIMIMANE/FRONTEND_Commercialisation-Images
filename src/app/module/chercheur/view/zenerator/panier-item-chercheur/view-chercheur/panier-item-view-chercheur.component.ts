...
@Component({
  selector: 'app-panier-item-view-chercheur',
  templateUrl: './panier-item-view-chercheur.component.html',
  styleUrls: ['./panier-item-view-chercheur.component.css']
})
export class PanierItemViewChercheurComponent implements OnInit {
