...
@Component({
  selector: 'app-panier-item-create-chercheur',
  templateUrl: './panier-item-create-chercheur.component.html',
  styleUrls: ['./panier-item-create-chercheur.component.css']
})
export class PanierItemCreateChercheurComponent implements OnInit {
