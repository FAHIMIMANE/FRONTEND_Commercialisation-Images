...
@Component({
  selector: 'app-categorie-image-create-chercheur',
  templateUrl: './categorie-image-create-chercheur.component.html',
  styleUrls: ['./categorie-image-create-chercheur.component.css']
})
export class CategorieImageCreateChercheurComponent implements OnInit {
