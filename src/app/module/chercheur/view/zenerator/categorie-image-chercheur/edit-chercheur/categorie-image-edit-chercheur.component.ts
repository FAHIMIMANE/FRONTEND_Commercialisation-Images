...
@Component({
  selector: 'app-categorie-image-edit-chercheur',
  templateUrl: './categorie-image-edit-chercheur.component.html',
  styleUrls: ['./categorie-image-edit-chercheur.component.css']
})
export class CategorieImageEditChercheurComponent implements OnInit {
