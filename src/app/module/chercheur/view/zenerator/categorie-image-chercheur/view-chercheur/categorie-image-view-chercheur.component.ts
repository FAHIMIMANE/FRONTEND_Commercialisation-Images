...
@Component({
  selector: 'app-categorie-image-view-chercheur',
  templateUrl: './categorie-image-view-chercheur.component.html',
  styleUrls: ['./categorie-image-view-chercheur.component.css']
})
export class CategorieImageViewChercheurComponent implements OnInit {
