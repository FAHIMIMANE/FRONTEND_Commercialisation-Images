...
@Component({
  selector: 'app-categorie-item-view-chercheur',
  templateUrl: './categorie-item-view-chercheur.component.html',
  styleUrls: ['./categorie-item-view-chercheur.component.css']
})
export class CategorieItemViewChercheurComponent implements OnInit {
