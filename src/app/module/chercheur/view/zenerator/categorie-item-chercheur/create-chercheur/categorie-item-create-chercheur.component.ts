...
@Component({
  selector: 'app-categorie-item-create-chercheur',
  templateUrl: './categorie-item-create-chercheur.component.html',
  styleUrls: ['./categorie-item-create-chercheur.component.css']
})
export class CategorieItemCreateChercheurComponent implements OnInit {
