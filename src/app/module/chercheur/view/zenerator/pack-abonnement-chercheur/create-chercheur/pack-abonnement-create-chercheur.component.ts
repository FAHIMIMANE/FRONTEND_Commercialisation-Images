...
@Component({
  selector: 'app-pack-abonnement-create-chercheur',
  templateUrl: './pack-abonnement-create-chercheur.component.html',
  styleUrls: ['./pack-abonnement-create-chercheur.component.css']
})
export class PackAbonnementCreateChercheurComponent implements OnInit {
