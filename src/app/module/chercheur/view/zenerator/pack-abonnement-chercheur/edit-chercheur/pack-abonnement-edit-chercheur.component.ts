...
@Component({
  selector: 'app-pack-abonnement-edit-chercheur',
  templateUrl: './pack-abonnement-edit-chercheur.component.html',
  styleUrls: ['./pack-abonnement-edit-chercheur.component.css']
})
export class PackAbonnementEditChercheurComponent implements OnInit {
