...
@Component({
  selector: 'app-pack-abonnement-list-chercheur',
  templateUrl: './pack-abonnement-list-chercheur.component.html',
  styleUrls: ['./pack-abonnement-list-chercheur.component.css']
})
export class PackAbonnementListChercheurComponent implements OnInit {
   // declarations
