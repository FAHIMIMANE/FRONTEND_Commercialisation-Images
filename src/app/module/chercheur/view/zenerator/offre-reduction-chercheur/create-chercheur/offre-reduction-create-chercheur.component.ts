...
@Component({
  selector: 'app-offre-reduction-create-chercheur',
  templateUrl: './offre-reduction-create-chercheur.component.html',
  styleUrls: ['./offre-reduction-create-chercheur.component.css']
})
export class OffreReductionCreateChercheurComponent implements OnInit {
