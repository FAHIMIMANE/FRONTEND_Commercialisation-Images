...
@Component({
  selector: 'app-offre-reduction-list-chercheur',
  templateUrl: './offre-reduction-list-chercheur.component.html',
  styleUrls: ['./offre-reduction-list-chercheur.component.css']
})
export class OffreReductionListChercheurComponent implements OnInit {
   // declarations
