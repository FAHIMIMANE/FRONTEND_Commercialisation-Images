...
@Component({
  selector: 'app-etat-abonnement-view-chercheur',
  templateUrl: './etat-abonnement-view-chercheur.component.html',
  styleUrls: ['./etat-abonnement-view-chercheur.component.css']
})
export class EtatAbonnementViewChercheurComponent implements OnInit {
