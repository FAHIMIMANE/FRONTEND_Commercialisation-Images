...
@Component({
  selector: 'app-etat-abonnement-list-chercheur',
  templateUrl: './etat-abonnement-list-chercheur.component.html',
  styleUrls: ['./etat-abonnement-list-chercheur.component.css']
})
export class EtatAbonnementListChercheurComponent implements OnInit {
   // declarations
