...
@Component({
  selector: 'app-etat-abonnement-edit-chercheur',
  templateUrl: './etat-abonnement-edit-chercheur.component.html',
  styleUrls: ['./etat-abonnement-edit-chercheur.component.css']
})
export class EtatAbonnementEditChercheurComponent implements OnInit {
