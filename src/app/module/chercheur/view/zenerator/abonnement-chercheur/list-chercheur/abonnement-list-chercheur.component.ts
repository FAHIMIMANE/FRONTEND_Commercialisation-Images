...
@Component({
  selector: 'app-abonnement-list-chercheur',
  templateUrl: './abonnement-list-chercheur.component.html',
  styleUrls: ['./abonnement-list-chercheur.component.css']
})
export class AbonnementListChercheurComponent implements OnInit {
   // declarations
