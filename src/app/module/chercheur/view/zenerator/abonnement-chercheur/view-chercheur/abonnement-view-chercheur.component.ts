...
@Component({
  selector: 'app-abonnement-view-chercheur',
  templateUrl: './abonnement-view-chercheur.component.html',
  styleUrls: ['./abonnement-view-chercheur.component.css']
})
export class AbonnementViewChercheurComponent implements OnInit {
