...
@Component({
  selector: 'app-bucket-list-chercheur',
  templateUrl: './bucket-list-chercheur.component.html',
  styleUrls: ['./bucket-list-chercheur.component.css']
})
export class BucketListChercheurComponent implements OnInit {
   // declarations
