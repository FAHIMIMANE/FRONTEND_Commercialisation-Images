...
@Component({
  selector: 'app-bucket-view-chercheur',
  templateUrl: './bucket-view-chercheur.component.html',
  styleUrls: ['./bucket-view-chercheur.component.css']
})
export class BucketViewChercheurComponent implements OnInit {
