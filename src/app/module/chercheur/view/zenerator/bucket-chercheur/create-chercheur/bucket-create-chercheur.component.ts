...
@Component({
  selector: 'app-bucket-create-chercheur',
  templateUrl: './bucket-create-chercheur.component.html',
  styleUrls: ['./bucket-create-chercheur.component.css']
})
export class BucketCreateChercheurComponent implements OnInit {
