...
@Component({
  selector: 'app-bucket-edit-chercheur',
  templateUrl: './bucket-edit-chercheur.component.html',
  styleUrls: ['./bucket-edit-chercheur.component.css']
})
export class BucketEditChercheurComponent implements OnInit {
