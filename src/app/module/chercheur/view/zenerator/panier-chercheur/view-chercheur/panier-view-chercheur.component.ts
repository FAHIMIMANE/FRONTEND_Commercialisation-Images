...
@Component({
  selector: 'app-panier-view-chercheur',
  templateUrl: './panier-view-chercheur.component.html',
  styleUrls: ['./panier-view-chercheur.component.css']
})
export class PanierViewChercheurComponent implements OnInit {
