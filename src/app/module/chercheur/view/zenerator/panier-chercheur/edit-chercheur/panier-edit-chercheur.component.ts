...
@Component({
  selector: 'app-panier-edit-chercheur',
  templateUrl: './panier-edit-chercheur.component.html',
  styleUrls: ['./panier-edit-chercheur.component.css']
})
export class PanierEditChercheurComponent implements OnInit {
