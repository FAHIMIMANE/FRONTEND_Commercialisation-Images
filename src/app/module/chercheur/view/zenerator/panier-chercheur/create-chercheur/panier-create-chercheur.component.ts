...
@Component({
  selector: 'app-panier-create-chercheur',
  templateUrl: './panier-create-chercheur.component.html',
  styleUrls: ['./panier-create-chercheur.component.css']
})
export class PanierCreateChercheurComponent implements OnInit {
