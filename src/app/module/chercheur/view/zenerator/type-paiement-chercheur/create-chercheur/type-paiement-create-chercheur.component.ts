...
@Component({
  selector: 'app-type-paiement-create-chercheur',
  templateUrl: './type-paiement-create-chercheur.component.html',
  styleUrls: ['./type-paiement-create-chercheur.component.css']
})
export class TypePaiementCreateChercheurComponent implements OnInit {
