...
@Component({
  selector: 'app-type-paiement-view-chercheur',
  templateUrl: './type-paiement-view-chercheur.component.html',
  styleUrls: ['./type-paiement-view-chercheur.component.css']
})
export class TypePaiementViewChercheurComponent implements OnInit {
