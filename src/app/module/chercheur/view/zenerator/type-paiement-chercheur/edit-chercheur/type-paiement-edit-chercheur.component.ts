...
@Component({
  selector: 'app-type-paiement-edit-chercheur',
  templateUrl: './type-paiement-edit-chercheur.component.html',
  styleUrls: ['./type-paiement-edit-chercheur.component.css']
})
export class TypePaiementEditChercheurComponent implements OnInit {
