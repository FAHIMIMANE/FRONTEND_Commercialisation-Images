...
@Component({
  selector: 'app-type-paiement-list-chercheur',
  templateUrl: './type-paiement-list-chercheur.component.html',
  styleUrls: ['./type-paiement-list-chercheur.component.css']
})
export class TypePaiementListChercheurComponent implements OnInit {
   // declarations
