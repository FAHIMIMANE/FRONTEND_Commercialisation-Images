...
@Component({
  selector: 'app-type-client-view-chercheur',
  templateUrl: './type-client-view-chercheur.component.html',
  styleUrls: ['./type-client-view-chercheur.component.css']
})
export class TypeClientViewChercheurComponent implements OnInit {
