...
@Component({
  selector: 'app-type-contributeur-view-chercheur',
  templateUrl: './type-contributeur-view-chercheur.component.html',
  styleUrls: ['./type-contributeur-view-chercheur.component.css']
})
export class TypeContributeurViewChercheurComponent implements OnInit {
