...
@Component({
  selector: 'app-type-contributeur-create-chercheur',
  templateUrl: './type-contributeur-create-chercheur.component.html',
  styleUrls: ['./type-contributeur-create-chercheur.component.css']
})
export class TypeContributeurCreateChercheurComponent implements OnInit {
