...
@Component({
  selector: 'app-type-contributeur-edit-chercheur',
  templateUrl: './type-contributeur-edit-chercheur.component.html',
  styleUrls: ['./type-contributeur-edit-chercheur.component.css']
})
export class TypeContributeurEditChercheurComponent implements OnInit {
