...
@Component({
  selector: 'app-tag-bucket-list-chercheur',
  templateUrl: './tag-bucket-list-chercheur.component.html',
  styleUrls: ['./tag-bucket-list-chercheur.component.css']
})
export class TagBucketListChercheurComponent implements OnInit {
   // declarations
