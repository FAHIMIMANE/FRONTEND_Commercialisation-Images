...
@Component({
  selector: 'app-tag-bucket-view-chercheur',
  templateUrl: './tag-bucket-view-chercheur.component.html',
  styleUrls: ['./tag-bucket-view-chercheur.component.css']
})
export class TagBucketViewChercheurComponent implements OnInit {
