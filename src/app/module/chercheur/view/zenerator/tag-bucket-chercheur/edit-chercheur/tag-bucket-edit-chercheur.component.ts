...
@Component({
  selector: 'app-tag-bucket-edit-chercheur',
  templateUrl: './tag-bucket-edit-chercheur.component.html',
  styleUrls: ['./tag-bucket-edit-chercheur.component.css']
})
export class TagBucketEditChercheurComponent implements OnInit {
