...
@Component({
  selector: 'app-tag-bucket-create-chercheur',
  templateUrl: './tag-bucket-create-chercheur.component.html',
  styleUrls: ['./tag-bucket-create-chercheur.component.css']
})
export class TagBucketCreateChercheurComponent implements OnInit {
