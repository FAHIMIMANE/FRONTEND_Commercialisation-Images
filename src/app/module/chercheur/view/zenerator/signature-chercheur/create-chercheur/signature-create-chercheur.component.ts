...
@Component({
  selector: 'app-signature-create-chercheur',
  templateUrl: './signature-create-chercheur.component.html',
  styleUrls: ['./signature-create-chercheur.component.css']
})
export class SignatureCreateChercheurComponent implements OnInit {
