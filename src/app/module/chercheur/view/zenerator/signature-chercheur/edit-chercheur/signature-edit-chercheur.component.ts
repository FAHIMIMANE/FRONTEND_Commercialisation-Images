...
@Component({
  selector: 'app-signature-edit-chercheur',
  templateUrl: './signature-edit-chercheur.component.html',
  styleUrls: ['./signature-edit-chercheur.component.css']
})
export class SignatureEditChercheurComponent implements OnInit {
