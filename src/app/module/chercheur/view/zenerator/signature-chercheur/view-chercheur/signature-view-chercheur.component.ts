...
@Component({
  selector: 'app-signature-view-chercheur',
  templateUrl: './signature-view-chercheur.component.html',
  styleUrls: ['./signature-view-chercheur.component.css']
})
export class SignatureViewChercheurComponent implements OnInit {
