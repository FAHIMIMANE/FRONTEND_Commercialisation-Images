...
@Component({
  selector: 'app-contract-edit-chercheur',
  templateUrl: './contract-edit-chercheur.component.html',
  styleUrls: ['./contract-edit-chercheur.component.css']
})
export class ContractEditChercheurComponent implements OnInit {
