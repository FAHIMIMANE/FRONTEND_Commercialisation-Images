...
@Component({
  selector: 'app-contract-list-chercheur',
  templateUrl: './contract-list-chercheur.component.html',
  styleUrls: ['./contract-list-chercheur.component.css']
})
export class ContractListChercheurComponent implements OnInit {
   // declarations
