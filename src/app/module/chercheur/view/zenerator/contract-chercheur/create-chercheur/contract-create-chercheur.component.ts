...
@Component({
  selector: 'app-contract-create-chercheur',
  templateUrl: './contract-create-chercheur.component.html',
  styleUrls: ['./contract-create-chercheur.component.css']
})
export class ContractCreateChercheurComponent implements OnInit {
