...
@Component({
  selector: 'app-contributeur-list-chercheur',
  templateUrl: './contributeur-list-chercheur.component.html',
  styleUrls: ['./contributeur-list-chercheur.component.css']
})
export class ContributeurListChercheurComponent implements OnInit {
   // declarations
