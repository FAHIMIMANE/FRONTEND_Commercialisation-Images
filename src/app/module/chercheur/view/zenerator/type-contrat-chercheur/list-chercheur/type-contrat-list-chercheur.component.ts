...
@Component({
  selector: 'app-type-contrat-list-chercheur',
  templateUrl: './type-contrat-list-chercheur.component.html',
  styleUrls: ['./type-contrat-list-chercheur.component.css']
})
export class TypeContratListChercheurComponent implements OnInit {
   // declarations
