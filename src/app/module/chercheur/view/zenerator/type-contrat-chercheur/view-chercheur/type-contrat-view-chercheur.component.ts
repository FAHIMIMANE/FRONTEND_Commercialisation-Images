...
@Component({
  selector: 'app-type-contrat-view-chercheur',
  templateUrl: './type-contrat-view-chercheur.component.html',
  styleUrls: ['./type-contrat-view-chercheur.component.css']
})
export class TypeContratViewChercheurComponent implements OnInit {
