...
@Component({
  selector: 'app-type-contrat-edit-chercheur',
  templateUrl: './type-contrat-edit-chercheur.component.html',
  styleUrls: ['./type-contrat-edit-chercheur.component.css']
})
export class TypeContratEditChercheurComponent implements OnInit {
