...
@Component({
  selector: 'app-image-view-chercheur',
  templateUrl: './image-view-chercheur.component.html',
  styleUrls: ['./image-view-chercheur.component.css']
})
export class ImageViewChercheurComponent implements OnInit {
