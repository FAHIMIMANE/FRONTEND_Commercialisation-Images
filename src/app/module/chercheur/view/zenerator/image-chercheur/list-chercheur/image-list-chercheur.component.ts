...
@Component({
  selector: 'app-image-list-chercheur',
  templateUrl: './image-list-chercheur.component.html',
  styleUrls: ['./image-list-chercheur.component.css']
})
export class ImageListChercheurComponent implements OnInit {
   // declarations
