...
@Component({
  selector: 'app-image-create-chercheur',
  templateUrl: './image-create-chercheur.component.html',
  styleUrls: ['./image-create-chercheur.component.css']
})
export class ImageCreateChercheurComponent implements OnInit {
