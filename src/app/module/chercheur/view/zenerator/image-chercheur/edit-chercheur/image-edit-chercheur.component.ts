...
@Component({
  selector: 'app-image-edit-chercheur',
  templateUrl: './image-edit-chercheur.component.html',
  styleUrls: ['./image-edit-chercheur.component.css']
})
export class ImageEditChercheurComponent implements OnInit {
