...
@Component({
  selector: 'app-etat-image-view-chercheur',
  templateUrl: './etat-image-view-chercheur.component.html',
  styleUrls: ['./etat-image-view-chercheur.component.css']
})
export class EtatImageViewChercheurComponent implements OnInit {
