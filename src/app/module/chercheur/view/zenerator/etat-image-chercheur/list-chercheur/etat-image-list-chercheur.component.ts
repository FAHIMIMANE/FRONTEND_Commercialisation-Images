...
@Component({
  selector: 'app-etat-image-list-chercheur',
  templateUrl: './etat-image-list-chercheur.component.html',
  styleUrls: ['./etat-image-list-chercheur.component.css']
})
export class EtatImageListChercheurComponent implements OnInit {
   // declarations
