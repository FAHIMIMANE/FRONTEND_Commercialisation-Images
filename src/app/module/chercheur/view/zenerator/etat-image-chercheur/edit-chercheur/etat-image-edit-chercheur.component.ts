...
@Component({
  selector: 'app-etat-image-edit-chercheur',
  templateUrl: './etat-image-edit-chercheur.component.html',
  styleUrls: ['./etat-image-edit-chercheur.component.css']
})
export class EtatImageEditChercheurComponent implements OnInit {
