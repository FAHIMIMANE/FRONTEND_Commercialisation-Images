...
@Component({
  selector: 'app-etat-image-create-chercheur',
  templateUrl: './etat-image-create-chercheur.component.html',
  styleUrls: ['./etat-image-create-chercheur.component.css']
})
export class EtatImageCreateChercheurComponent implements OnInit {
