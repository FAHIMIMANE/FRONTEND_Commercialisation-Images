...
@Component({
  selector: 'app-client-list-contributeur',
  templateUrl: './client-list-contributeur.component.html',
  styleUrls: ['./client-list-contributeur.component.css']
})
export class ClientListContributeurComponent implements OnInit {
   // declarations
