...
@Component({
  selector: 'app-client-view-contributeur',
  templateUrl: './client-view-contributeur.component.html',
  styleUrls: ['./client-view-contributeur.component.css']
})
export class ClientViewContributeurComponent implements OnInit {
