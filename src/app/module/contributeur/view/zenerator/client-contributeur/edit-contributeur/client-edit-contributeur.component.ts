...
@Component({
  selector: 'app-client-edit-contributeur',
  templateUrl: './client-edit-contributeur.component.html',
  styleUrls: ['./client-edit-contributeur.component.css']
})
export class ClientEditContributeurComponent implements OnInit {
