...
@Component({
  selector: 'app-type-image-create-contributeur',
  templateUrl: './type-image-create-contributeur.component.html',
  styleUrls: ['./type-image-create-contributeur.component.css']
})
export class TypeImageCreateContributeurComponent implements OnInit {
