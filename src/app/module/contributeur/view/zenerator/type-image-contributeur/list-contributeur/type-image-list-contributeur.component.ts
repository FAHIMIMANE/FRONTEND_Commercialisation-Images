...
@Component({
  selector: 'app-type-image-list-contributeur',
  templateUrl: './type-image-list-contributeur.component.html',
  styleUrls: ['./type-image-list-contributeur.component.css']
})
export class TypeImageListContributeurComponent implements OnInit {
   // declarations
