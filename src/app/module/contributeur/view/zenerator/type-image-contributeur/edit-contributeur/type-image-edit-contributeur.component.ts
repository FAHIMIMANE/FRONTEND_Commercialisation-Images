...
@Component({
  selector: 'app-type-image-edit-contributeur',
  templateUrl: './type-image-edit-contributeur.component.html',
  styleUrls: ['./type-image-edit-contributeur.component.css']
})
export class TypeImageEditContributeurComponent implements OnInit {
