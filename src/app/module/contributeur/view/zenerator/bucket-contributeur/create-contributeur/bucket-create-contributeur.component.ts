...
@Component({
  selector: 'app-bucket-create-contributeur',
  templateUrl: './bucket-create-contributeur.component.html',
  styleUrls: ['./bucket-create-contributeur.component.css']
})
export class BucketCreateContributeurComponent implements OnInit {
