...
@Component({
  selector: 'app-type-client-list-contributeur',
  templateUrl: './type-client-list-contributeur.component.html',
  styleUrls: ['./type-client-list-contributeur.component.css']
})
export class TypeClientListContributeurComponent implements OnInit {
   // declarations
