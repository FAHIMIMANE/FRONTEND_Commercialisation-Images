...
@Component({
  selector: 'app-type-client-create-contributeur',
  templateUrl: './type-client-create-contributeur.component.html',
  styleUrls: ['./type-client-create-contributeur.component.css']
})
export class TypeClientCreateContributeurComponent implements OnInit {
