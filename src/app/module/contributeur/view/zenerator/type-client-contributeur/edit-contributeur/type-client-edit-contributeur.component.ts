...
@Component({
  selector: 'app-type-client-edit-contributeur',
  templateUrl: './type-client-edit-contributeur.component.html',
  styleUrls: ['./type-client-edit-contributeur.component.css']
})
export class TypeClientEditContributeurComponent implements OnInit {
