...
@Component({
  selector: 'app-categorie-item-create-contributeur',
  templateUrl: './categorie-item-create-contributeur.component.html',
  styleUrls: ['./categorie-item-create-contributeur.component.css']
})
export class CategorieItemCreateContributeurComponent implements OnInit {
