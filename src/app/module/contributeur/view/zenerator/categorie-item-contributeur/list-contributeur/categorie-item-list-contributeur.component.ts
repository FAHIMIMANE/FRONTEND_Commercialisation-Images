...
@Component({
  selector: 'app-categorie-item-list-contributeur',
  templateUrl: './categorie-item-list-contributeur.component.html',
  styleUrls: ['./categorie-item-list-contributeur.component.css']
})
export class CategorieItemListContributeurComponent implements OnInit {
   // declarations
