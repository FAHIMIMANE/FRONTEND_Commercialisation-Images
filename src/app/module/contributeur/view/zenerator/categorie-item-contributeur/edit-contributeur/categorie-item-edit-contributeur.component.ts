...
@Component({
  selector: 'app-categorie-item-edit-contributeur',
  templateUrl: './categorie-item-edit-contributeur.component.html',
  styleUrls: ['./categorie-item-edit-contributeur.component.css']
})
export class CategorieItemEditContributeurComponent implements OnInit {
