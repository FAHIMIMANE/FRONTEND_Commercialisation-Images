...
@Component({
  selector: 'app-etat-image-edit-contributeur',
  templateUrl: './etat-image-edit-contributeur.component.html',
  styleUrls: ['./etat-image-edit-contributeur.component.css']
})
export class EtatImageEditContributeurComponent implements OnInit {
