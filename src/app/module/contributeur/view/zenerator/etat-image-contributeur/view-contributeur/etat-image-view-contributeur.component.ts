...
@Component({
  selector: 'app-etat-image-view-contributeur',
  templateUrl: './etat-image-view-contributeur.component.html',
  styleUrls: ['./etat-image-view-contributeur.component.css']
})
export class EtatImageViewContributeurComponent implements OnInit {
