...
@Component({
  selector: 'app-etat-image-list-contributeur',
  templateUrl: './etat-image-list-contributeur.component.html',
  styleUrls: ['./etat-image-list-contributeur.component.css']
})
export class EtatImageListContributeurComponent implements OnInit {
   // declarations
