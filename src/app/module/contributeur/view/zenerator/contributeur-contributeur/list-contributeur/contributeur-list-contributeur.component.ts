...
@Component({
  selector: 'app-contributeur-list-contributeur',
  templateUrl: './contributeur-list-contributeur.component.html',
  styleUrls: ['./contributeur-list-contributeur.component.css']
})
export class ContributeurListContributeurComponent implements OnInit {
   // declarations
