...
@Component({
  selector: 'app-contributeur-edit-contributeur',
  templateUrl: './contributeur-edit-contributeur.component.html',
  styleUrls: ['./contributeur-edit-contributeur.component.css']
})
export class ContributeurEditContributeurComponent implements OnInit {
