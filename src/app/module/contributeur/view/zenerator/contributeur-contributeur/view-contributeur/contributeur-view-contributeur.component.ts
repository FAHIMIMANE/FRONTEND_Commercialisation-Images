...
@Component({
  selector: 'app-contributeur-view-contributeur',
  templateUrl: './contributeur-view-contributeur.component.html',
  styleUrls: ['./contributeur-view-contributeur.component.css']
})
export class ContributeurViewContributeurComponent implements OnInit {
