...
@Component({
  selector: 'app-etat-panier-edit-contributeur',
  templateUrl: './etat-panier-edit-contributeur.component.html',
  styleUrls: ['./etat-panier-edit-contributeur.component.css']
})
export class EtatPanierEditContributeurComponent implements OnInit {
