...
@Component({
  selector: 'app-etat-panier-create-contributeur',
  templateUrl: './etat-panier-create-contributeur.component.html',
  styleUrls: ['./etat-panier-create-contributeur.component.css']
})
export class EtatPanierCreateContributeurComponent implements OnInit {
