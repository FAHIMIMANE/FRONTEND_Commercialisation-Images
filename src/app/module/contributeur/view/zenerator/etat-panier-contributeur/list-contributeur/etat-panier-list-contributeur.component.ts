...
@Component({
  selector: 'app-etat-panier-list-contributeur',
  templateUrl: './etat-panier-list-contributeur.component.html',
  styleUrls: ['./etat-panier-list-contributeur.component.css']
})
export class EtatPanierListContributeurComponent implements OnInit {
   // declarations
