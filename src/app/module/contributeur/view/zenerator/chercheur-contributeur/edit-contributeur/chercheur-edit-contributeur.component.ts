...
@Component({
  selector: 'app-chercheur-edit-contributeur',
  templateUrl: './chercheur-edit-contributeur.component.html',
  styleUrls: ['./chercheur-edit-contributeur.component.css']
})
export class ChercheurEditContributeurComponent implements OnInit {
