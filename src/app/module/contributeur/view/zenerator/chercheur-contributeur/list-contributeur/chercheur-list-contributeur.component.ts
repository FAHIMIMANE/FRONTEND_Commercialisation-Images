...
@Component({
  selector: 'app-chercheur-list-contributeur',
  templateUrl: './chercheur-list-contributeur.component.html',
  styleUrls: ['./chercheur-list-contributeur.component.css']
})
export class ChercheurListContributeurComponent implements OnInit {
   // declarations
