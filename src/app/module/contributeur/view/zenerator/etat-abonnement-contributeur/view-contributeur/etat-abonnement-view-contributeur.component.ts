...
@Component({
  selector: 'app-etat-abonnement-view-contributeur',
  templateUrl: './etat-abonnement-view-contributeur.component.html',
  styleUrls: ['./etat-abonnement-view-contributeur.component.css']
})
export class EtatAbonnementViewContributeurComponent implements OnInit {
