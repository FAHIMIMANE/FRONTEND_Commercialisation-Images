...
@Component({
  selector: 'app-etat-abonnement-list-contributeur',
  templateUrl: './etat-abonnement-list-contributeur.component.html',
  styleUrls: ['./etat-abonnement-list-contributeur.component.css']
})
export class EtatAbonnementListContributeurComponent implements OnInit {
   // declarations
