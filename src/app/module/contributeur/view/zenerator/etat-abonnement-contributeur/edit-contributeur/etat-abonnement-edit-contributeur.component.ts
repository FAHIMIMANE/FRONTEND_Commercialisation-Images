...
@Component({
  selector: 'app-etat-abonnement-edit-contributeur',
  templateUrl: './etat-abonnement-edit-contributeur.component.html',
  styleUrls: ['./etat-abonnement-edit-contributeur.component.css']
})
export class EtatAbonnementEditContributeurComponent implements OnInit {
