...
@Component({
  selector: 'app-type-paiement-view-contributeur',
  templateUrl: './type-paiement-view-contributeur.component.html',
  styleUrls: ['./type-paiement-view-contributeur.component.css']
})
export class TypePaiementViewContributeurComponent implements OnInit {
