...
@Component({
  selector: 'app-type-paiement-create-contributeur',
  templateUrl: './type-paiement-create-contributeur.component.html',
  styleUrls: ['./type-paiement-create-contributeur.component.css']
})
export class TypePaiementCreateContributeurComponent implements OnInit {
