...
@Component({
  selector: 'app-type-paiement-list-contributeur',
  templateUrl: './type-paiement-list-contributeur.component.html',
  styleUrls: ['./type-paiement-list-contributeur.component.css']
})
export class TypePaiementListContributeurComponent implements OnInit {
   // declarations
