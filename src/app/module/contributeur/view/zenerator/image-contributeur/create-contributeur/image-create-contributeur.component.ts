...
@Component({
    selector: 'app-image-create-contributeur',
    templateUrl: './image-create-contributeur.component.html',
    styleUrls: ['./image-create-contributeur.component.css']
})
export class ImageCreateContributeurComponent implements OnInit {
