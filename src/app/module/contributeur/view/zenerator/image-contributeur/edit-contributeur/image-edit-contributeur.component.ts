...
@Component({
  selector: 'app-image-edit-contributeur',
  templateUrl: './image-edit-contributeur.component.html',
  styleUrls: ['./image-edit-contributeur.component.css']
})
export class ImageEditContributeurComponent implements OnInit {
