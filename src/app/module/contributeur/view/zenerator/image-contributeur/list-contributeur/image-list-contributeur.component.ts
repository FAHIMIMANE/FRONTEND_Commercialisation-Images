...
@Component({
    selector: 'app-image-list-contributeur',
    templateUrl: './image-list-contributeur.component.html',
    styleUrls: ['./image-list-contributeur.component.css']
})
export class ImageListContributeurComponent implements OnInit {
    // declarations
    ...
    initDuplicateImage(res: ImageVo) {
        if (res.categorieItemsVo != null) {
            res.categorieItemsVo.forEach(d => { d.imageVo = null; d.id = null; });
        }
