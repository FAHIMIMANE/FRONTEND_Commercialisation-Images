...
@Component({
  selector: 'app-pack-abonnement-view-contributeur',
  templateUrl: './pack-abonnement-view-contributeur.component.html',
  styleUrls: ['./pack-abonnement-view-contributeur.component.css']
})
export class PackAbonnementViewContributeurComponent implements OnInit {
