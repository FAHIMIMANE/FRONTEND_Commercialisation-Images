...
@Component({
  selector: 'app-pack-abonnement-list-contributeur',
  templateUrl: './pack-abonnement-list-contributeur.component.html',
  styleUrls: ['./pack-abonnement-list-contributeur.component.css']
})
export class PackAbonnementListContributeurComponent implements OnInit {
   // declarations
