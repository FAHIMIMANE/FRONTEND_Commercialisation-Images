...
@Component({
  selector: 'app-pack-abonnement-edit-contributeur',
  templateUrl: './pack-abonnement-edit-contributeur.component.html',
  styleUrls: ['./pack-abonnement-edit-contributeur.component.css']
})
export class PackAbonnementEditContributeurComponent implements OnInit {
