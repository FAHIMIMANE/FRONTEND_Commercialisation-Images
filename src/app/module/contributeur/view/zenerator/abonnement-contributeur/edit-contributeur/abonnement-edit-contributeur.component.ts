...
@Component({
  selector: 'app-abonnement-edit-contributeur',
  templateUrl: './abonnement-edit-contributeur.component.html',
  styleUrls: ['./abonnement-edit-contributeur.component.css']
})
export class AbonnementEditContributeurComponent implements OnInit {
