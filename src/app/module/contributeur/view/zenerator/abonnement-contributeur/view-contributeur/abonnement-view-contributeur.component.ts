...
@Component({
  selector: 'app-abonnement-view-contributeur',
  templateUrl: './abonnement-view-contributeur.component.html',
  styleUrls: ['./abonnement-view-contributeur.component.css']
})
export class AbonnementViewContributeurComponent implements OnInit {
