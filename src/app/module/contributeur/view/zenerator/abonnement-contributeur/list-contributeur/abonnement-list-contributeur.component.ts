...
@Component({
  selector: 'app-abonnement-list-contributeur',
  templateUrl: './abonnement-list-contributeur.component.html',
  styleUrls: ['./abonnement-list-contributeur.component.css']
})
export class AbonnementListContributeurComponent implements OnInit {
   // declarations
