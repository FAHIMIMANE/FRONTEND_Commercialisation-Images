...
@Component({
  selector: 'app-signature-view-contributeur',
  templateUrl: './signature-view-contributeur.component.html',
  styleUrls: ['./signature-view-contributeur.component.css']
})
export class SignatureViewContributeurComponent implements OnInit {
