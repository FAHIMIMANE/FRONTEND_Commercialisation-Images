...
@Component({
  selector: 'app-signature-list-contributeur',
  templateUrl: './signature-list-contributeur.component.html',
  styleUrls: ['./signature-list-contributeur.component.css']
})
export class SignatureListContributeurComponent implements OnInit {
   // declarations
