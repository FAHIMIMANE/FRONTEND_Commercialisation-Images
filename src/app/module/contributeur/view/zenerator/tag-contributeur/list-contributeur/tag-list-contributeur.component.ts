...
@Component({
  selector: 'app-tag-list-contributeur',
  templateUrl: './tag-list-contributeur.component.html',
  styleUrls: ['./tag-list-contributeur.component.css']
})
export class TagListContributeurComponent implements OnInit {
   // declarations
