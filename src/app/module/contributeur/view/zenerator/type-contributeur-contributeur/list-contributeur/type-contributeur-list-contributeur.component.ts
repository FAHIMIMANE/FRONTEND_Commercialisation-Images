...
@Component({
  selector: 'app-type-contributeur-list-contributeur',
  templateUrl: './type-contributeur-list-contributeur.component.html',
  styleUrls: ['./type-contributeur-list-contributeur.component.css']
})
export class TypeContributeurListContributeurComponent implements OnInit {
   // declarations
