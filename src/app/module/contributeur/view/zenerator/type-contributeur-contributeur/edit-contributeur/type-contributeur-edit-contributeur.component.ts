...
@Component({
  selector: 'app-type-contributeur-edit-contributeur',
  templateUrl: './type-contributeur-edit-contributeur.component.html',
  styleUrls: ['./type-contributeur-edit-contributeur.component.css']
})
export class TypeContributeurEditContributeurComponent implements OnInit {
