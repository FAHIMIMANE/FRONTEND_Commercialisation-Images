...
@Component({
  selector: 'app-type-contributeur-create-contributeur',
  templateUrl: './type-contributeur-create-contributeur.component.html',
  styleUrls: ['./type-contributeur-create-contributeur.component.css']
})
export class TypeContributeurCreateContributeurComponent implements OnInit {
