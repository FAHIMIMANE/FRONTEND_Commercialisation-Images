...
@Component({
  selector: 'app-type-contributeur-view-contributeur',
  templateUrl: './type-contributeur-view-contributeur.component.html',
  styleUrls: ['./type-contributeur-view-contributeur.component.css']
})
export class TypeContributeurViewContributeurComponent implements OnInit {
