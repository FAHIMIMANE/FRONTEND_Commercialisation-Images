...
@Component({
  selector: 'app-tag-bucket-create-contributeur',
  templateUrl: './tag-bucket-create-contributeur.component.html',
  styleUrls: ['./tag-bucket-create-contributeur.component.css']
})
export class TagBucketCreateContributeurComponent implements OnInit {
