...
@Component({
  selector: 'app-tag-bucket-list-contributeur',
  templateUrl: './tag-bucket-list-contributeur.component.html',
  styleUrls: ['./tag-bucket-list-contributeur.component.css']
})
export class TagBucketListContributeurComponent implements OnInit {
   // declarations
