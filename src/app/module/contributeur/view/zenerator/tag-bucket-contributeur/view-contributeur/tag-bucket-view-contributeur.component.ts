...
@Component({
  selector: 'app-tag-bucket-view-contributeur',
  templateUrl: './tag-bucket-view-contributeur.component.html',
  styleUrls: ['./tag-bucket-view-contributeur.component.css']
})
export class TagBucketViewContributeurComponent implements OnInit {
