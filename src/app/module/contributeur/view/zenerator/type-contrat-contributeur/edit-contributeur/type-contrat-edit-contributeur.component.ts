...
@Component({
  selector: 'app-type-contrat-edit-contributeur',
  templateUrl: './type-contrat-edit-contributeur.component.html',
  styleUrls: ['./type-contrat-edit-contributeur.component.css']
})
export class TypeContratEditContributeurComponent implements OnInit {
