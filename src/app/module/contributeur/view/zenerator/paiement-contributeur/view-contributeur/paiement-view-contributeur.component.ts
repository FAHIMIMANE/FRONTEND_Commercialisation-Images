...
@Component({
  selector: 'app-paiement-view-contributeur',
  templateUrl: './paiement-view-contributeur.component.html',
  styleUrls: ['./paiement-view-contributeur.component.css']
})
export class PaiementViewContributeurComponent implements OnInit {
