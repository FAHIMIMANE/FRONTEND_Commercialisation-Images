...
@Component({
  selector: 'app-paiement-edit-contributeur',
  templateUrl: './paiement-edit-contributeur.component.html',
  styleUrls: ['./paiement-edit-contributeur.component.css']
})
export class PaiementEditContributeurComponent implements OnInit {
