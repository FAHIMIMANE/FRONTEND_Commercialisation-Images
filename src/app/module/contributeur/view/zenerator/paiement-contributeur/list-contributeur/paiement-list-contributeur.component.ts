...
@Component({
  selector: 'app-paiement-list-contributeur',
  templateUrl: './paiement-list-contributeur.component.html',
  styleUrls: ['./paiement-list-contributeur.component.css']
})
export class PaiementListContributeurComponent implements OnInit {
   // declarations
