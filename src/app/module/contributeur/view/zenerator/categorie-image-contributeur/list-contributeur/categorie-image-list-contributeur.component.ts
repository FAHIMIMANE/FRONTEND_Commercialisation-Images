...
@Component({
  selector: 'app-categorie-image-list-contributeur',
  templateUrl: './categorie-image-list-contributeur.component.html',
  styleUrls: ['./categorie-image-list-contributeur.component.css']
})
export class CategorieImageListContributeurComponent implements OnInit {
   // declarations
