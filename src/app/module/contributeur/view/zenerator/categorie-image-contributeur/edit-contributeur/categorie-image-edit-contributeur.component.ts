...
@Component({
  selector: 'app-categorie-image-edit-contributeur',
  templateUrl: './categorie-image-edit-contributeur.component.html',
  styleUrls: ['./categorie-image-edit-contributeur.component.css']
})
export class CategorieImageEditContributeurComponent implements OnInit {
