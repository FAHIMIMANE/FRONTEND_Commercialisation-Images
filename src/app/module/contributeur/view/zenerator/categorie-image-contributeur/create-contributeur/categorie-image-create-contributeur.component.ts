...
@Component({
  selector: 'app-categorie-image-create-contributeur',
  templateUrl: './categorie-image-create-contributeur.component.html',
  styleUrls: ['./categorie-image-create-contributeur.component.css']
})
export class CategorieImageCreateContributeurComponent implements OnInit {
