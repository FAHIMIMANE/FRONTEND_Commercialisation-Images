...
@Component({
  selector: 'app-offre-reduction-create-contributeur',
  templateUrl: './offre-reduction-create-contributeur.component.html',
  styleUrls: ['./offre-reduction-create-contributeur.component.css']
})
export class OffreReductionCreateContributeurComponent implements OnInit {
