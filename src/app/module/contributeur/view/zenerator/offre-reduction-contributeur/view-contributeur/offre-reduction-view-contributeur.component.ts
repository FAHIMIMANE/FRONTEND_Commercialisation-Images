...
@Component({
  selector: 'app-offre-reduction-view-contributeur',
  templateUrl: './offre-reduction-view-contributeur.component.html',
  styleUrls: ['./offre-reduction-view-contributeur.component.css']
})
export class OffreReductionViewContributeurComponent implements OnInit {
