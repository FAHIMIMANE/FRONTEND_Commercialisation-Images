...
@Component({
  selector: 'app-offre-reduction-edit-contributeur',
  templateUrl: './offre-reduction-edit-contributeur.component.html',
  styleUrls: ['./offre-reduction-edit-contributeur.component.css']
})
export class OffreReductionEditContributeurComponent implements OnInit {
