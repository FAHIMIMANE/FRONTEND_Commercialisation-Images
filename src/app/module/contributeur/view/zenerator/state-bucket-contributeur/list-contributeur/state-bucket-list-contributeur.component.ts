...
@Component({
  selector: 'app-state-bucket-list-contributeur',
  templateUrl: './state-bucket-list-contributeur.component.html',
  styleUrls: ['./state-bucket-list-contributeur.component.css']
})
export class StateBucketListContributeurComponent implements OnInit {
   // declarations
