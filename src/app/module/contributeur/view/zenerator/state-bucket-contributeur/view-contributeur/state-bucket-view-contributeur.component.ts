...
@Component({
  selector: 'app-state-bucket-view-contributeur',
  templateUrl: './state-bucket-view-contributeur.component.html',
  styleUrls: ['./state-bucket-view-contributeur.component.css']
})
export class StateBucketViewContributeurComponent implements OnInit {
