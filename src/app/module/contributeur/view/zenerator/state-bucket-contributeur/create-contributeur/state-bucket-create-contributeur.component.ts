...
@Component({
  selector: 'app-state-bucket-create-contributeur',
  templateUrl: './state-bucket-create-contributeur.component.html',
  styleUrls: ['./state-bucket-create-contributeur.component.css']
})
export class StateBucketCreateContributeurComponent implements OnInit {
