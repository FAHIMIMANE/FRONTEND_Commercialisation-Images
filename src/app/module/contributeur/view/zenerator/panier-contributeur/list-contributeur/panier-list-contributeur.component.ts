...
@Component({
  selector: 'app-panier-list-contributeur',
  templateUrl: './panier-list-contributeur.component.html',
  styleUrls: ['./panier-list-contributeur.component.css']
})
export class PanierListContributeurComponent implements OnInit {
   // declarations
