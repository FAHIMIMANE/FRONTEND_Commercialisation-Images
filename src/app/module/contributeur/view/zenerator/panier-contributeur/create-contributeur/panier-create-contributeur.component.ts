...
@Component({
  selector: 'app-panier-create-contributeur',
  templateUrl: './panier-create-contributeur.component.html',
  styleUrls: ['./panier-create-contributeur.component.css']
})
export class PanierCreateContributeurComponent implements OnInit {
