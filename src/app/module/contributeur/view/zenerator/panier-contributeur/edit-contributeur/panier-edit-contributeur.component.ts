...
@Component({
  selector: 'app-panier-edit-contributeur',
  templateUrl: './panier-edit-contributeur.component.html',
  styleUrls: ['./panier-edit-contributeur.component.css']
})
export class PanierEditContributeurComponent implements OnInit {
