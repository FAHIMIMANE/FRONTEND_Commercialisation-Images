...
@Component({
  selector: 'app-contract-view-contributeur',
  templateUrl: './contract-view-contributeur.component.html',
  styleUrls: ['./contract-view-contributeur.component.css']
})
export class ContractViewContributeurComponent implements OnInit {
