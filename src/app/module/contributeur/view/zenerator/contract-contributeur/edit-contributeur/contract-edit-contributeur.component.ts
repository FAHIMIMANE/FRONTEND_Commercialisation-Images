...
@Component({
  selector: 'app-contract-edit-contributeur',
  templateUrl: './contract-edit-contributeur.component.html',
  styleUrls: ['./contract-edit-contributeur.component.css']
})
export class ContractEditContributeurComponent implements OnInit {
