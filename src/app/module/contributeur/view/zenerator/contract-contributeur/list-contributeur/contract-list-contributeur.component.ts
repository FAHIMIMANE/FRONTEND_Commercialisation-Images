...
@Component({
  selector: 'app-contract-list-contributeur',
  templateUrl: './contract-list-contributeur.component.html',
  styleUrls: ['./contract-list-contributeur.component.css']
})
export class ContractListContributeurComponent implements OnInit {
   // declarations
