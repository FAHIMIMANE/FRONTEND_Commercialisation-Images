...
@Component({
  selector: 'app-panier-item-edit-contributeur',
  templateUrl: './panier-item-edit-contributeur.component.html',
  styleUrls: ['./panier-item-edit-contributeur.component.css']
})
export class PanierItemEditContributeurComponent implements OnInit {
