...
@Component({
  selector: 'app-panier-item-create-contributeur',
  templateUrl: './panier-item-create-contributeur.component.html',
  styleUrls: ['./panier-item-create-contributeur.component.css']
})
export class PanierItemCreateContributeurComponent implements OnInit {
