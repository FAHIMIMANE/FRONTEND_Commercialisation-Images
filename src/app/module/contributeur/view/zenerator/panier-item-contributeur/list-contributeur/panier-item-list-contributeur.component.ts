...
@Component({
  selector: 'app-panier-item-list-contributeur',
  templateUrl: './panier-item-list-contributeur.component.html',
  styleUrls: ['./panier-item-list-contributeur.component.css']
})
export class PanierItemListContributeurComponent implements OnInit {
   // declarations
