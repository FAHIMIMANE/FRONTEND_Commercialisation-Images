...
@Component({
  selector: 'app-etat-abonnement-edit-client',
  templateUrl: './etat-abonnement-edit-client.component.html',
  styleUrls: ['./etat-abonnement-edit-client.component.css']
})
export class EtatAbonnementEditClientComponent implements OnInit {
