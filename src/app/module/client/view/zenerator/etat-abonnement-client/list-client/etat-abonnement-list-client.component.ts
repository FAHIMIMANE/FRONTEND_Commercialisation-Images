...
@Component({
  selector: 'app-etat-abonnement-list-client',
  templateUrl: './etat-abonnement-list-client.component.html',
  styleUrls: ['./etat-abonnement-list-client.component.css']
})
export class EtatAbonnementListClientComponent implements OnInit {
   // declarations
