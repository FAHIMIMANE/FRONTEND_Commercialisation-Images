...
@Component({
  selector: 'app-type-contrat-view-client',
  templateUrl: './type-contrat-view-client.component.html',
  styleUrls: ['./type-contrat-view-client.component.css']
})
export class TypeContratViewClientComponent implements OnInit {
