...
@Component({
  selector: 'app-type-contrat-list-client',
  templateUrl: './type-contrat-list-client.component.html',
  styleUrls: ['./type-contrat-list-client.component.css']
})
export class TypeContratListClientComponent implements OnInit {
   // declarations
