...
@Component({
  selector: 'app-type-contrat-create-client',
  templateUrl: './type-contrat-create-client.component.html',
  styleUrls: ['./type-contrat-create-client.component.css']
})
export class TypeContratCreateClientComponent implements OnInit {
