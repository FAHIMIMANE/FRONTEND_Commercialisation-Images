...
@Component({
  selector: 'app-categorie-image-create-client',
  templateUrl: './categorie-image-create-client.component.html',
  styleUrls: ['./categorie-image-create-client.component.css']
})
export class CategorieImageCreateClientComponent implements OnInit {
