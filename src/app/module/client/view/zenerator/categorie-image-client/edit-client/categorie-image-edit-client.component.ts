...
@Component({
  selector: 'app-categorie-image-edit-client',
  templateUrl: './categorie-image-edit-client.component.html',
  styleUrls: ['./categorie-image-edit-client.component.css']
})
export class CategorieImageEditClientComponent implements OnInit {
