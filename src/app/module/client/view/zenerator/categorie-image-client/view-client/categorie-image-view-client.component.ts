...
@Component({
  selector: 'app-categorie-image-view-client',
  templateUrl: './categorie-image-view-client.component.html',
  styleUrls: ['./categorie-image-view-client.component.css']
})
export class CategorieImageViewClientComponent implements OnInit {
