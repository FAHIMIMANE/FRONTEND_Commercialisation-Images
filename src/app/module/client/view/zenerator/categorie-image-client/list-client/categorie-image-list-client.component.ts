...
@Component({
  selector: 'app-categorie-image-list-client',
  templateUrl: './categorie-image-list-client.component.html',
  styleUrls: ['./categorie-image-list-client.component.css']
})
export class CategorieImageListClientComponent implements OnInit {
   // declarations
