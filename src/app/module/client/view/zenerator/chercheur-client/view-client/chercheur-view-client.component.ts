...
@Component({
  selector: 'app-chercheur-view-client',
  templateUrl: './chercheur-view-client.component.html',
  styleUrls: ['./chercheur-view-client.component.css']
})
export class ChercheurViewClientComponent implements OnInit {
