...
@Component({
  selector: 'app-categorie-item-edit-client',
  templateUrl: './categorie-item-edit-client.component.html',
  styleUrls: ['./categorie-item-edit-client.component.css']
})
export class CategorieItemEditClientComponent implements OnInit {
