...
@Component({
  selector: 'app-categorie-item-list-client',
  templateUrl: './categorie-item-list-client.component.html',
  styleUrls: ['./categorie-item-list-client.component.css']
})
export class CategorieItemListClientComponent implements OnInit {
   // declarations
