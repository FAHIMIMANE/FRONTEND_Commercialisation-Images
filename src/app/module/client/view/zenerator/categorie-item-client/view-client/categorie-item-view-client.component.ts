...
@Component({
  selector: 'app-categorie-item-view-client',
  templateUrl: './categorie-item-view-client.component.html',
  styleUrls: ['./categorie-item-view-client.component.css']
})
export class CategorieItemViewClientComponent implements OnInit {
