...
@Component({
  selector: 'app-tag-edit-client',
  templateUrl: './tag-edit-client.component.html',
  styleUrls: ['./tag-edit-client.component.css']
})
export class TagEditClientComponent implements OnInit {
