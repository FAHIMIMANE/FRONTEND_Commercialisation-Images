...
@Component({
  selector: 'app-tag-view-client',
  templateUrl: './tag-view-client.component.html',
  styleUrls: ['./tag-view-client.component.css']
})
export class TagViewClientComponent implements OnInit {
