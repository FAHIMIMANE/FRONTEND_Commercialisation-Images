...
@Component({
  selector: 'app-image-view-client',
  templateUrl: './image-view-client.component.html',
  styleUrls: ['./image-view-client.component.css']
})
export class ImageViewClientComponent implements OnInit {
