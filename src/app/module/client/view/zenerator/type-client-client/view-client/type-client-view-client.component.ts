...
@Component({
  selector: 'app-type-client-view-client',
  templateUrl: './type-client-view-client.component.html',
  styleUrls: ['./type-client-view-client.component.css']
})
export class TypeClientViewClientComponent implements OnInit {
