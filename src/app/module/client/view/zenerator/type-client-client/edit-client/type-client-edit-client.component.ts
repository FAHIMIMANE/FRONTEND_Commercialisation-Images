...
@Component({
  selector: 'app-type-client-edit-client',
  templateUrl: './type-client-edit-client.component.html',
  styleUrls: ['./type-client-edit-client.component.css']
})
export class TypeClientEditClientComponent implements OnInit {
