...
@Component({
  selector: 'app-contributeur-view-client',
  templateUrl: './contributeur-view-client.component.html',
  styleUrls: ['./contributeur-view-client.component.css']
})
export class ContributeurViewClientComponent implements OnInit {
