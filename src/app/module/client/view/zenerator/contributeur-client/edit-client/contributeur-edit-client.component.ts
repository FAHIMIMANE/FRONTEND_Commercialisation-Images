...
@Component({
  selector: 'app-contributeur-edit-client',
  templateUrl: './contributeur-edit-client.component.html',
  styleUrls: ['./contributeur-edit-client.component.css']
})
export class ContributeurEditClientComponent implements OnInit {
