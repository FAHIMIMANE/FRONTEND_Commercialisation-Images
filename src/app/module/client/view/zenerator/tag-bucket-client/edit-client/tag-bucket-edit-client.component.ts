...
@Component({
  selector: 'app-tag-bucket-edit-client',
  templateUrl: './tag-bucket-edit-client.component.html',
  styleUrls: ['./tag-bucket-edit-client.component.css']
})
export class TagBucketEditClientComponent implements OnInit {
