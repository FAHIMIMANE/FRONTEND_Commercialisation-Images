...
@Component({
  selector: 'app-tag-bucket-view-client',
  templateUrl: './tag-bucket-view-client.component.html',
  styleUrls: ['./tag-bucket-view-client.component.css']
})
export class TagBucketViewClientComponent implements OnInit {
