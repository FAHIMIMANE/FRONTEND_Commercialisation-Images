...
@Component({
  selector: 'app-tag-bucket-create-client',
  templateUrl: './tag-bucket-create-client.component.html',
  styleUrls: ['./tag-bucket-create-client.component.css']
})
export class TagBucketCreateClientComponent implements OnInit {
