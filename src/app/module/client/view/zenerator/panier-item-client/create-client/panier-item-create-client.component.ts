...
@Component({
  selector: 'app-panier-item-create-client',
  templateUrl: './panier-item-create-client.component.html',
  styleUrls: ['./panier-item-create-client.component.css']
})
export class PanierItemCreateClientComponent implements OnInit {
