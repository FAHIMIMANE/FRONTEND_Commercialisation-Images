...
@Component({
  selector: 'app-panier-item-view-client',
  templateUrl: './panier-item-view-client.component.html',
  styleUrls: ['./panier-item-view-client.component.css']
})
export class PanierItemViewClientComponent implements OnInit {
