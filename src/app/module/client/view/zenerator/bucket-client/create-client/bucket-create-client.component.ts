...
@Component({
  selector: 'app-bucket-create-client',
  templateUrl: './bucket-create-client.component.html',
  styleUrls: ['./bucket-create-client.component.css']
})
export class BucketCreateClientComponent implements OnInit {
