...
@Component({
  selector: 'app-bucket-list-client',
  templateUrl: './bucket-list-client.component.html',
  styleUrls: ['./bucket-list-client.component.css']
})
export class BucketListClientComponent implements OnInit {
   // declarations
