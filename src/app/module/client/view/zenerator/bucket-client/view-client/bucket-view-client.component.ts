...
@Component({
  selector: 'app-bucket-view-client',
  templateUrl: './bucket-view-client.component.html',
  styleUrls: ['./bucket-view-client.component.css']
})
export class BucketViewClientComponent implements OnInit {
