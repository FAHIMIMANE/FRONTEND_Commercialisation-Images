...
@Component({
  selector: 'app-bucket-edit-client',
  templateUrl: './bucket-edit-client.component.html',
  styleUrls: ['./bucket-edit-client.component.css']
})
export class BucketEditClientComponent implements OnInit {
