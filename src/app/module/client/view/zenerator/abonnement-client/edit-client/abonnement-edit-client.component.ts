...
@Component({
  selector: 'app-abonnement-edit-client',
  templateUrl: './abonnement-edit-client.component.html',
  styleUrls: ['./abonnement-edit-client.component.css']
})
export class AbonnementEditClientComponent implements OnInit {
