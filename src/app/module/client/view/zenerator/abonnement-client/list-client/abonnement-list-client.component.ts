...
@Component({
  selector: 'app-abonnement-list-client',
  templateUrl: './abonnement-list-client.component.html',
  styleUrls: ['./abonnement-list-client.component.css']
})
export class AbonnementListClientComponent implements OnInit {
   // declarations
