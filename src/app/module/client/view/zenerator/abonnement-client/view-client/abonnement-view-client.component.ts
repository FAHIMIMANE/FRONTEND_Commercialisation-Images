...
@Component({
  selector: 'app-abonnement-view-client',
  templateUrl: './abonnement-view-client.component.html',
  styleUrls: ['./abonnement-view-client.component.css']
})
export class AbonnementViewClientComponent implements OnInit {
