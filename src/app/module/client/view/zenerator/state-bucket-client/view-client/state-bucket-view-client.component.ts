...
@Component({
  selector: 'app-state-bucket-view-client',
  templateUrl: './state-bucket-view-client.component.html',
  styleUrls: ['./state-bucket-view-client.component.css']
})
export class StateBucketViewClientComponent implements OnInit {
