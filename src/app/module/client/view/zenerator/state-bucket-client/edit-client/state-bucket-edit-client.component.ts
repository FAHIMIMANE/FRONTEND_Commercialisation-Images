...
@Component({
  selector: 'app-state-bucket-edit-client',
  templateUrl: './state-bucket-edit-client.component.html',
  styleUrls: ['./state-bucket-edit-client.component.css']
})
export class StateBucketEditClientComponent implements OnInit {
