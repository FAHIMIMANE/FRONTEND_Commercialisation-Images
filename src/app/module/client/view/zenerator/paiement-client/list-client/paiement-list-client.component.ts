...
@Component({
  selector: 'app-paiement-list-client',
  templateUrl: './paiement-list-client.component.html',
  styleUrls: ['./paiement-list-client.component.css']
})
export class PaiementListClientComponent implements OnInit {
   // declarations
