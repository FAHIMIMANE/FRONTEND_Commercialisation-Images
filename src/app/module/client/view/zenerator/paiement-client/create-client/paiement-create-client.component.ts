...
@Component({
  selector: 'app-paiement-create-client',
  templateUrl: './paiement-create-client.component.html',
  styleUrls: ['./paiement-create-client.component.css']
})
export class PaiementCreateClientComponent implements OnInit {
