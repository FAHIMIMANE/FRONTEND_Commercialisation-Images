...
@Component({
  selector: 'app-paiement-edit-client',
  templateUrl: './paiement-edit-client.component.html',
  styleUrls: ['./paiement-edit-client.component.css']
})
export class PaiementEditClientComponent implements OnInit {
