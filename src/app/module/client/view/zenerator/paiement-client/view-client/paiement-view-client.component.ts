...
@Component({
  selector: 'app-paiement-view-client',
  templateUrl: './paiement-view-client.component.html',
  styleUrls: ['./paiement-view-client.component.css']
})
export class PaiementViewClientComponent implements OnInit {
