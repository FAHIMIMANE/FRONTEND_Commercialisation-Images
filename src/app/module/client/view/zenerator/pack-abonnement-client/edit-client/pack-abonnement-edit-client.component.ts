...
@Component({
  selector: 'app-pack-abonnement-edit-client',
  templateUrl: './pack-abonnement-edit-client.component.html',
  styleUrls: ['./pack-abonnement-edit-client.component.css']
})
export class PackAbonnementEditClientComponent implements OnInit {
