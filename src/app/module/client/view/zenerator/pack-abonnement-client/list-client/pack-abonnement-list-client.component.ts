...
@Component({
  selector: 'app-pack-abonnement-list-client',
  templateUrl: './pack-abonnement-list-client.component.html',
  styleUrls: ['./pack-abonnement-list-client.component.css']
})
export class PackAbonnementListClientComponent implements OnInit {
   // declarations
