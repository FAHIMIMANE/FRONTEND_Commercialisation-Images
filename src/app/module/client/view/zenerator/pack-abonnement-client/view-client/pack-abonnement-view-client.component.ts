...
@Component({
  selector: 'app-pack-abonnement-view-client',
  templateUrl: './pack-abonnement-view-client.component.html',
  styleUrls: ['./pack-abonnement-view-client.component.css']
})
export class PackAbonnementViewClientComponent implements OnInit {
