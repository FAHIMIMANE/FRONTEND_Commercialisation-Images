...
@Component({
  selector: 'app-type-paiement-edit-client',
  templateUrl: './type-paiement-edit-client.component.html',
  styleUrls: ['./type-paiement-edit-client.component.css']
})
export class TypePaiementEditClientComponent implements OnInit {
