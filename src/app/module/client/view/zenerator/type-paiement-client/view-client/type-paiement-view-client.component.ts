...
@Component({
  selector: 'app-type-paiement-view-client',
  templateUrl: './type-paiement-view-client.component.html',
  styleUrls: ['./type-paiement-view-client.component.css']
})
export class TypePaiementViewClientComponent implements OnInit {
