...
@Component({
  selector: 'app-type-paiement-create-client',
  templateUrl: './type-paiement-create-client.component.html',
  styleUrls: ['./type-paiement-create-client.component.css']
})
export class TypePaiementCreateClientComponent implements OnInit {
