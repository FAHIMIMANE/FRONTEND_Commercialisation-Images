...
@Component({
  selector: 'app-offre-reduction-edit-client',
  templateUrl: './offre-reduction-edit-client.component.html',
  styleUrls: ['./offre-reduction-edit-client.component.css']
})
export class OffreReductionEditClientComponent implements OnInit {
