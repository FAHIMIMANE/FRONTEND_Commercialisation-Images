...
@Component({
  selector: 'app-offre-reduction-list-client',
  templateUrl: './offre-reduction-list-client.component.html',
  styleUrls: ['./offre-reduction-list-client.component.css']
})
export class OffreReductionListClientComponent implements OnInit {
   // declarations
