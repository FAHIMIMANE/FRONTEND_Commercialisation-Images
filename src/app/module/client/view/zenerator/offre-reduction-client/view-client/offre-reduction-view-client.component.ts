...
@Component({
  selector: 'app-offre-reduction-view-client',
  templateUrl: './offre-reduction-view-client.component.html',
  styleUrls: ['./offre-reduction-view-client.component.css']
})
export class OffreReductionViewClientComponent implements OnInit {
