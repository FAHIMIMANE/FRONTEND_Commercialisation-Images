...
@Component({
  selector: 'app-type-contributeur-view-client',
  templateUrl: './type-contributeur-view-client.component.html',
  styleUrls: ['./type-contributeur-view-client.component.css']
})
export class TypeContributeurViewClientComponent implements OnInit {
