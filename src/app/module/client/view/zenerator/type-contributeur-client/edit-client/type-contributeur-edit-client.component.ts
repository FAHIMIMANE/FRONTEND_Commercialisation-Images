...
@Component({
  selector: 'app-type-contributeur-edit-client',
  templateUrl: './type-contributeur-edit-client.component.html',
  styleUrls: ['./type-contributeur-edit-client.component.css']
})
export class TypeContributeurEditClientComponent implements OnInit {
