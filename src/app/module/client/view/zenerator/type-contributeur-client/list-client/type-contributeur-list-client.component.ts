...
@Component({
  selector: 'app-type-contributeur-list-client',
  templateUrl: './type-contributeur-list-client.component.html',
  styleUrls: ['./type-contributeur-list-client.component.css']
})
export class TypeContributeurListClientComponent implements OnInit {
   // declarations
