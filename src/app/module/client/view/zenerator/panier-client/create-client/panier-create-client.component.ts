...
@Component({
  selector: 'app-panier-create-client',
  templateUrl: './panier-create-client.component.html',
  styleUrls: ['./panier-create-client.component.css']
})
export class PanierCreateClientComponent implements OnInit {
