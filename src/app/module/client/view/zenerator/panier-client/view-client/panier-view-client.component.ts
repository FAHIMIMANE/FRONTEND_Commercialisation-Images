...
@Component({
  selector: 'app-panier-view-client',
  templateUrl: './panier-view-client.component.html',
  styleUrls: ['./panier-view-client.component.css']
})
export class PanierViewClientComponent implements OnInit {
