...
@Component({
  selector: 'app-panier-list-client',
  templateUrl: './panier-list-client.component.html',
  styleUrls: ['./panier-list-client.component.css']
})
export class PanierListClientComponent implements OnInit {
   // declarations
