...
@Component({
  selector: 'app-panier-edit-client',
  templateUrl: './panier-edit-client.component.html',
  styleUrls: ['./panier-edit-client.component.css']
})
export class PanierEditClientComponent implements OnInit {
