...
@Component({
  selector: 'app-etat-image-view-client',
  templateUrl: './etat-image-view-client.component.html',
  styleUrls: ['./etat-image-view-client.component.css']
})
export class EtatImageViewClientComponent implements OnInit {
