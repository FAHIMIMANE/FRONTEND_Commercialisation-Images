...
@Component({
  selector: 'app-etat-image-create-client',
  templateUrl: './etat-image-create-client.component.html',
  styleUrls: ['./etat-image-create-client.component.css']
})
export class EtatImageCreateClientComponent implements OnInit {
