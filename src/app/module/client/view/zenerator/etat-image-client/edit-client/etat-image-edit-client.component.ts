...
@Component({
  selector: 'app-etat-image-edit-client',
  templateUrl: './etat-image-edit-client.component.html',
  styleUrls: ['./etat-image-edit-client.component.css']
})
export class EtatImageEditClientComponent implements OnInit {
