...
@Component({
  selector: 'app-signature-list-client',
  templateUrl: './signature-list-client.component.html',
  styleUrls: ['./signature-list-client.component.css']
})
export class SignatureListClientComponent implements OnInit {
   // declarations
