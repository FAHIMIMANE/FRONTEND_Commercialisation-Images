...
@Component({
  selector: 'app-signature-edit-client',
  templateUrl: './signature-edit-client.component.html',
  styleUrls: ['./signature-edit-client.component.css']
})
export class SignatureEditClientComponent implements OnInit {
