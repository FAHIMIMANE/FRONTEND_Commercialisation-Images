...
@Component({
  selector: 'app-type-image-edit-client',
  templateUrl: './type-image-edit-client.component.html',
  styleUrls: ['./type-image-edit-client.component.css']
})
export class TypeImageEditClientComponent implements OnInit {
