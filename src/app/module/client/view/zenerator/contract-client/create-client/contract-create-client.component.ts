...
@Component({
  selector: 'app-contract-create-client',
  templateUrl: './contract-create-client.component.html',
  styleUrls: ['./contract-create-client.component.css']
})
export class ContractCreateClientComponent implements OnInit {
