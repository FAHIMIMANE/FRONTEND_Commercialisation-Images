...
@Component({
  selector: 'app-contract-view-client',
  templateUrl: './contract-view-client.component.html',
  styleUrls: ['./contract-view-client.component.css']
})
export class ContractViewClientComponent implements OnInit {
