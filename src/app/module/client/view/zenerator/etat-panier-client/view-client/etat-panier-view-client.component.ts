...
@Component({
  selector: 'app-etat-panier-view-client',
  templateUrl: './etat-panier-view-client.component.html',
  styleUrls: ['./etat-panier-view-client.component.css']
})
export class EtatPanierViewClientComponent implements OnInit {
