...
@Component({
  selector: 'app-etat-panier-create-client',
  templateUrl: './etat-panier-create-client.component.html',
  styleUrls: ['./etat-panier-create-client.component.css']
})
export class EtatPanierCreateClientComponent implements OnInit {
