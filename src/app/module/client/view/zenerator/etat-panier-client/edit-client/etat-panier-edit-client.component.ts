...
@Component({
  selector: 'app-etat-panier-edit-client',
  templateUrl: './etat-panier-edit-client.component.html',
  styleUrls: ['./etat-panier-edit-client.component.css']
})
export class EtatPanierEditClientComponent implements OnInit {
