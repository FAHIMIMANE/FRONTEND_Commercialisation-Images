...
@Component({
  selector: 'app-etat-panier-list-client',
  templateUrl: './etat-panier-list-client.component.html',
  styleUrls: ['./etat-panier-list-client.component.css']
})
export class EtatPanierListClientComponent implements OnInit {
   // declarations
