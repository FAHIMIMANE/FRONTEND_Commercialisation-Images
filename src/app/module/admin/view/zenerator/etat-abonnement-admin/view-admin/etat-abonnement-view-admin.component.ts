...
@Component({
  selector: 'app-etat-abonnement-view-admin',
  templateUrl: './etat-abonnement-view-admin.component.html',
  styleUrls: ['./etat-abonnement-view-admin.component.css']
})
export class EtatAbonnementViewAdminComponent implements OnInit {
