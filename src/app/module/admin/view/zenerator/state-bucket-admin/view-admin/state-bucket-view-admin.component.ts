...
@Component({
  selector: 'app-state-bucket-view-admin',
  templateUrl: './state-bucket-view-admin.component.html',
  styleUrls: ['./state-bucket-view-admin.component.css']
})
export class StateBucketViewAdminComponent implements OnInit {
