...
@Component({
  selector: 'app-state-bucket-edit-admin',
  templateUrl: './state-bucket-edit-admin.component.html',
  styleUrls: ['./state-bucket-edit-admin.component.css']
})
export class StateBucketEditAdminComponent implements OnInit {
