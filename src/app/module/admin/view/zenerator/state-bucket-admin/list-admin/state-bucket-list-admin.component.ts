...
@Component({
  selector: 'app-state-bucket-list-admin',
  templateUrl: './state-bucket-list-admin.component.html',
  styleUrls: ['./state-bucket-list-admin.component.css']
})
export class StateBucketListAdminComponent implements OnInit {
   // declarations
