...
@Component({
  selector: 'app-pack-abonnement-view-admin',
  templateUrl: './pack-abonnement-view-admin.component.html',
  styleUrls: ['./pack-abonnement-view-admin.component.css']
})
export class PackAbonnementViewAdminComponent implements OnInit {
