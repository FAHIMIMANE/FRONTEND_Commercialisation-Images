...
@Component({
  selector: 'app-bucket-list-admin',
  templateUrl: './bucket-list-admin.component.html',
  styleUrls: ['./bucket-list-admin.component.css']
})
export class BucketListAdminComponent implements OnInit {
   // declarations
