...
@Component({
  selector: 'app-bucket-view-admin',
  templateUrl: './bucket-view-admin.component.html',
  styleUrls: ['./bucket-view-admin.component.css']
})
export class BucketViewAdminComponent implements OnInit {
