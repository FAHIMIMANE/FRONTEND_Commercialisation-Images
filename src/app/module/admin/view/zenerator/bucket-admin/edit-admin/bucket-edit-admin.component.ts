...
@Component({
  selector: 'app-bucket-edit-admin',
  templateUrl: './bucket-edit-admin.component.html',
  styleUrls: ['./bucket-edit-admin.component.css']
})
export class BucketEditAdminComponent implements OnInit {
