...
@Component({
  selector: 'app-panier-view-admin',
  templateUrl: './panier-view-admin.component.html',
  styleUrls: ['./panier-view-admin.component.css']
})
export class PanierViewAdminComponent implements OnInit {
