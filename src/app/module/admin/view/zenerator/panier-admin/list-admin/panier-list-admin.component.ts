...
@Component({
  selector: 'app-panier-list-admin',
  templateUrl: './panier-list-admin.component.html',
  styleUrls: ['./panier-list-admin.component.css']
})
export class PanierListAdminComponent implements OnInit {
   // declarations
