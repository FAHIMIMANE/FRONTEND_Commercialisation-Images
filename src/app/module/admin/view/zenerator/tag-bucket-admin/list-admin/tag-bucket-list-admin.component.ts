...
@Component({
  selector: 'app-tag-bucket-list-admin',
  templateUrl: './tag-bucket-list-admin.component.html',
  styleUrls: ['./tag-bucket-list-admin.component.css']
})
export class TagBucketListAdminComponent implements OnInit {
   // declarations
