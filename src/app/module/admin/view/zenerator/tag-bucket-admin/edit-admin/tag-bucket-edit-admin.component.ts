...
@Component({
  selector: 'app-tag-bucket-edit-admin',
  templateUrl: './tag-bucket-edit-admin.component.html',
  styleUrls: ['./tag-bucket-edit-admin.component.css']
})
export class TagBucketEditAdminComponent implements OnInit {
