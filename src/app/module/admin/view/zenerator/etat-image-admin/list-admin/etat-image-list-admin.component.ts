...
@Component({
  selector: 'app-etat-image-list-admin',
  templateUrl: './etat-image-list-admin.component.html',
  styleUrls: ['./etat-image-list-admin.component.css']
})
export class EtatImageListAdminComponent implements OnInit {
   // declarations
