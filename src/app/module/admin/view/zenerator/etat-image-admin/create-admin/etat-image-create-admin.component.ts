...
@Component({
  selector: 'app-etat-image-create-admin',
  templateUrl: './etat-image-create-admin.component.html',
  styleUrls: ['./etat-image-create-admin.component.css']
})
export class EtatImageCreateAdminComponent implements OnInit {
