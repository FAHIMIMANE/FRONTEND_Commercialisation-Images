...
@Component({
  selector: 'app-contributeur-view-admin',
  templateUrl: './contributeur-view-admin.component.html',
  styleUrls: ['./contributeur-view-admin.component.css']
})
export class ContributeurViewAdminComponent implements OnInit {
