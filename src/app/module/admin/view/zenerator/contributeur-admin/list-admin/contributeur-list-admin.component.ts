...
@Component({
  selector: 'app-contributeur-list-admin',
  templateUrl: './contributeur-list-admin.component.html',
  styleUrls: ['./contributeur-list-admin.component.css']
})
export class ContributeurListAdminComponent implements OnInit {
   // declarations
