...
@Component({
  selector: 'app-type-client-view-admin',
  templateUrl: './type-client-view-admin.component.html',
  styleUrls: ['./type-client-view-admin.component.css']
})
export class TypeClientViewAdminComponent implements OnInit {
