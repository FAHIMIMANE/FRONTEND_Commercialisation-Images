...
@Component({
  selector: 'app-categorie-item-edit-admin',
  templateUrl: './categorie-item-edit-admin.component.html',
  styleUrls: ['./categorie-item-edit-admin.component.css']
})
export class CategorieItemEditAdminComponent implements OnInit {
