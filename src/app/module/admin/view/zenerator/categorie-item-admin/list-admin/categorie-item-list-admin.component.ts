...
@Component({
  selector: 'app-categorie-item-list-admin',
  templateUrl: './categorie-item-list-admin.component.html',
  styleUrls: ['./categorie-item-list-admin.component.css']
})
export class CategorieItemListAdminComponent implements OnInit {
   // declarations
