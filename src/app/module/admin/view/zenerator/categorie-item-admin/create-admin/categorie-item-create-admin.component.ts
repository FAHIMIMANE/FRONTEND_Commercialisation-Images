...
@Component({
  selector: 'app-categorie-item-create-admin',
  templateUrl: './categorie-item-create-admin.component.html',
  styleUrls: ['./categorie-item-create-admin.component.css']
})
export class CategorieItemCreateAdminComponent implements OnInit {
