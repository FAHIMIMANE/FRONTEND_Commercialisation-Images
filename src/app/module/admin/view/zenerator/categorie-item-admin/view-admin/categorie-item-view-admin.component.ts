...
@Component({
  selector: 'app-categorie-item-view-admin',
  templateUrl: './categorie-item-view-admin.component.html',
  styleUrls: ['./categorie-item-view-admin.component.css']
})
export class CategorieItemViewAdminComponent implements OnInit {
