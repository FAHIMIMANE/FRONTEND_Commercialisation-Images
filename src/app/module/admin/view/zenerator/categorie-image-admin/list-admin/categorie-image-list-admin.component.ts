...
@Component({
  selector: 'app-categorie-image-list-admin',
  templateUrl: './categorie-image-list-admin.component.html',
  styleUrls: ['./categorie-image-list-admin.component.css']
})
export class CategorieImageListAdminComponent implements OnInit {
   // declarations
