...
@Component({
  selector: 'app-categorie-image-view-admin',
  templateUrl: './categorie-image-view-admin.component.html',
  styleUrls: ['./categorie-image-view-admin.component.css']
})
export class CategorieImageViewAdminComponent implements OnInit {
