...
@Component({
  selector: 'app-offre-reduction-edit-admin',
  templateUrl: './offre-reduction-edit-admin.component.html',
  styleUrls: ['./offre-reduction-edit-admin.component.css']
})
export class OffreReductionEditAdminComponent implements OnInit {
