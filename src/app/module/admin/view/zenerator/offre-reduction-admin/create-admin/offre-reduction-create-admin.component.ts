...
@Component({
  selector: 'app-offre-reduction-create-admin',
  templateUrl: './offre-reduction-create-admin.component.html',
  styleUrls: ['./offre-reduction-create-admin.component.css']
})
export class OffreReductionCreateAdminComponent implements OnInit {
