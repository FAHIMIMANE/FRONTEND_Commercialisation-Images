...
@Component({
  selector: 'app-offre-reduction-list-admin',
  templateUrl: './offre-reduction-list-admin.component.html',
  styleUrls: ['./offre-reduction-list-admin.component.css']
})
export class OffreReductionListAdminComponent implements OnInit {
   // declarations
