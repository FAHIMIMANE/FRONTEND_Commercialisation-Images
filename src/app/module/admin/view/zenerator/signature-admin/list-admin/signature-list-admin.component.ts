...
@Component({
  selector: 'app-signature-list-admin',
  templateUrl: './signature-list-admin.component.html',
  styleUrls: ['./signature-list-admin.component.css']
})
export class SignatureListAdminComponent implements OnInit {
   // declarations
