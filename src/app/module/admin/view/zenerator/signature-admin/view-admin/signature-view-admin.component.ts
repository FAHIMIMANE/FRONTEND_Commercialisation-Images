...
@Component({
  selector: 'app-signature-view-admin',
  templateUrl: './signature-view-admin.component.html',
  styleUrls: ['./signature-view-admin.component.css']
})
export class SignatureViewAdminComponent implements OnInit {
