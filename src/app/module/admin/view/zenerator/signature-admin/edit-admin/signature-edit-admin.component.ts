...
@Component({
  selector: 'app-signature-edit-admin',
  templateUrl: './signature-edit-admin.component.html',
  styleUrls: ['./signature-edit-admin.component.css']
})
export class SignatureEditAdminComponent implements OnInit {
