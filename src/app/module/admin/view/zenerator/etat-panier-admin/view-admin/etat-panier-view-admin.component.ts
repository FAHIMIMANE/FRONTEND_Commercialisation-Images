...
@Component({
  selector: 'app-etat-panier-view-admin',
  templateUrl: './etat-panier-view-admin.component.html',
  styleUrls: ['./etat-panier-view-admin.component.css']
})
export class EtatPanierViewAdminComponent implements OnInit {
