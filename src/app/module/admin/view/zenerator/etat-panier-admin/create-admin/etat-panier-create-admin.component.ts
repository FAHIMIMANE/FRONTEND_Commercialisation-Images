...
@Component({
  selector: 'app-etat-panier-create-admin',
  templateUrl: './etat-panier-create-admin.component.html',
  styleUrls: ['./etat-panier-create-admin.component.css']
})
export class EtatPanierCreateAdminComponent implements OnInit {
