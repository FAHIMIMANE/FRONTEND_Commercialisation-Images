...
@Component({
  selector: 'app-image-edit-admin',
  templateUrl: './image-edit-admin.component.html',
  styleUrls: ['./image-edit-admin.component.css']
})
export class ImageEditAdminComponent implements OnInit {
