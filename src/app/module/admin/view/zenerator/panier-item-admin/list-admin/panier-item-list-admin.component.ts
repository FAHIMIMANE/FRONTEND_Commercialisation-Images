...
@Component({
    selector: 'app-panier-item-list-admin',
    templateUrl: './panier-item-list-admin.component.html',
    styleUrls: ['./panier-item-list-admin.component.css']
})
export class PanierItemListAdminComponent implements OnInit {
    // declarations
