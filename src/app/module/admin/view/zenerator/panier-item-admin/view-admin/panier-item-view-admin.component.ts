...
@Component({
  selector: 'app-panier-item-view-admin',
  templateUrl: './panier-item-view-admin.component.html',
  styleUrls: ['./panier-item-view-admin.component.css']
})
export class PanierItemViewAdminComponent implements OnInit {
