...
@Component({
  selector: 'app-panier-item-edit-admin',
  templateUrl: './panier-item-edit-admin.component.html',
  styleUrls: ['./panier-item-edit-admin.component.css']
})
export class PanierItemEditAdminComponent implements OnInit {
