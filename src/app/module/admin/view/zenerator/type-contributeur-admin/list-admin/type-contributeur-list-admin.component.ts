...
@Component({
  selector: 'app-type-contributeur-list-admin',
  templateUrl: './type-contributeur-list-admin.component.html',
  styleUrls: ['./type-contributeur-list-admin.component.css']
})
export class TypeContributeurListAdminComponent implements OnInit {
   // declarations
