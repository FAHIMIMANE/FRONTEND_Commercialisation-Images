...
@Component({
  selector: 'app-type-contributeur-create-admin',
  templateUrl: './type-contributeur-create-admin.component.html',
  styleUrls: ['./type-contributeur-create-admin.component.css']
})
export class TypeContributeurCreateAdminComponent implements OnInit {
