...
@Component({
  selector: 'app-contract-view-admin',
  templateUrl: './contract-view-admin.component.html',
  styleUrls: ['./contract-view-admin.component.css']
})
export class ContractViewAdminComponent implements OnInit {
