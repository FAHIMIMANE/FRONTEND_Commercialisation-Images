...
@Component({
  selector: 'app-contract-list-admin',
  templateUrl: './contract-list-admin.component.html',
  styleUrls: ['./contract-list-admin.component.css']
})
export class ContractListAdminComponent implements OnInit {
   // declarations
